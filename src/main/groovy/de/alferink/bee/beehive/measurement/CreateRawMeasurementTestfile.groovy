...
class CreateRawMeasurementTestfile {
    ...
    static main(def args) {
        ...
        def file = new File('C:\\dev\\projects\\beebee\\measurement-test2.csv')
        ...
        beehiveIds.each{ String beehiveId ->
            ...
            365.times {
                ...
                humidityOutside = Math.max(30, Math.min(99.0, humidityOutside + ThreadLocalRandom.current().nextDouble(-2, 2)))
